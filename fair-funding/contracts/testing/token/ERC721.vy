...
@external
def safeMint(_to: address, _tokenId: uint256) -> bool:
    """
    @dev Function to mint tokens with interface 
        compatible to OpenZeppelin implementation
...
@external
def DEBUG_transferMinter(_newMinter: address):
